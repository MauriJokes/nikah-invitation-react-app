    ...
    <div className="py-6 px-2">
      ...
      <div className="relative max-w-lg mx-auto">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, #AFCBFF 15%, #AFCBFF 85%, transparent)",
          }}
        />
        ...
        <div className="flex flex-col gap-8">
          {timelineEvents.map((event, i) => (
            <div key={i} className="flex gap-6 items-start pl-2">
              {/* Date bubble */}
              <div
                className="relative shrink-0 w-12 h-12 rounded-full flex flex-col items-center justify-center"
                style={{
                  background: "#AFCBFF",
