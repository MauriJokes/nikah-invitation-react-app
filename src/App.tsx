...
function AppInner() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(145deg, #EEF3FA 0%, #F5EFE8 55%, #EAF0F7 100%)",
      }}
    >
      <BackgroundParticles />
      ...
      <AnimatePresence>
        {appState === "cards" && (
          ...
          >
            ...
            <span
              style={{
                fontWeight: isMusicPlaying ? 600 : 400,
                color: isMusicPlaying ? "#2B2B2B" : "#9CA3AF",
              }}
            >
          ...
          >
            ...
            >
              <div className="flex flex-col items-center gap-6">
                ...
                >
                  Dk Izyan Naqiyah <br /> &amp; <br /> Nik Adam Danish
                </h1>
              </div>
            </motion.div>
